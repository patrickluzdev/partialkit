...
The second covers every place shadcn/ui pairs muted text with a muted surface: a
[Kbd](/components/kbd/), an avatar fallback, an avatar group count, and a description inside a
checked choice card. All of them pass in dark mode.
